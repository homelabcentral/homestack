...
print("\n── text ─────────────────────────────────────")
questionary.text("What is your domain name?", default="homelab.local", style=S).ask()

print("\n── password ──────────────────────────────────")
questionary.password("Enter your admin password:", style=S).ask()

print("\n── confirm ───────────────────────────────────")
questionary.confirm("Enable HTTPS redirect?", default=True, style=S).ask()
...
print("\n── path ──────────────────────────────────────")
questionary.path("Media library path:", default="/mnt/media", style=S).ask()
